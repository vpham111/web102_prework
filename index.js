...
const outputStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently
...
shortDesc.innerHTML = outputStr
descriptionContainer.appendChild(shortDesc)
...
//const name, desc, pl, goal, bkrs, img = sortedGames[0]

// create a new element to hold the name of the top pledge game, then append it to the correct element
const topPledged = document.createElement('h4')
